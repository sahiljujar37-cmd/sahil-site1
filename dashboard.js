                ...
                <tr>
                    ...
                    <td>
                        <button class="action-btn btn-delete"
                            onclick="deleteReviewFromDashboard('${rev.id}')">
                            Delete
                        </button>
                    </td>
                </tr>`).join('')}
...
function loadDashboard() {
    ...
    if (document.getElementById('memberBadge'))
        document.getElementById('memberBadge').textContent  = members.length + ' total';
    if (document.getElementById('bookingBadge'))
        document.getElementById('bookingBadge').textContent = bookings.length + ' total';
    if (document.getElementById('reviewBadge'))
        document.getElementById('reviewBadge').textContent  = reviews.length + ' total';
